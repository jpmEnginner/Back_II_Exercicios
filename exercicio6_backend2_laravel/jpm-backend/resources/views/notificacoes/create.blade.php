        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h4 class="mb-0">➕ Criar Nova Notificação</h4>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('notificacoes.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('mensagem') is-invalid @enderror" id="mensagem"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('data_envio') is-invalid @enderror"
                                    id="data_envio" name="data_envio" value="{{ old('data_envio', time()) }}" required>
                                <small class="text-muted">Valor atual: {{ time() }}</small>
                                @error('data_envio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('tipo_notificacao') is-invalid @enderror"
                                    ...
                                    <option value="1" {{ old('tipo_notificacao') == '1' ? 'selected' : '' }}>Tipo 1 - Geral
                                    </option>
                                    <option value="2" {{ old('tipo_notificacao') == '2' ? 'selected' : '' }}>Tipo 2 - Viagem
                                    </option>
                                    <option value="3" {{ old('tipo_notificacao') == '3' ? 'selected' : '' }}>Tipo 3 -
                                        Pagamento</option>
                                    <option value="4" {{ old('tipo_notificacao') == '4' ? 'selected' : '' }}>Tipo 4 - Sistema
                                    </option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('lida') is-invalid @enderror" id="lida" name="lida">
                                    <option value="0" {{ old('lida') == '0' ? 'selected' : '' }}>Não Lida</option>
                                    <option value="1" {{ old('lida') == '1' ? 'selected' : '' }}>Lida</option>
                                </select>
                                @error('lida')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('viagem_id') is-invalid @enderror"
                                    id="viagem_id" name="viagem_id" value="{{ old('viagem_id') }}">
